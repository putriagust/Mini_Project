...
Mobile.setText(findTestObject(''), 'terserah01', 0)

Mobile.tap(findTestObject('Object Repository/Register/android.widget.EditText - alexemail.com, Email (2)'), 0)

Mobile.setText(findTestObject(''), 'terserah01@gmail.com', 0)

Mobile.tap(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password (2)'), 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password (3)'), '123456', 
    0)
